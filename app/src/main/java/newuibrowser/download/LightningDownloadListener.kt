...
import newuibrowser.dialog.BrowserDialog.setDialogSize
import newuibrowser.extensions.KDuration
...
import newuibrowser.utils.guessFileName
...
class LightningDownloadListener     //Injector.getInjector(context).inject(this);
    ...
    val downloadHandler: newuibrowser.download.DownloadHandler = hiltEntryPoint.downloadHandler
        ...
        if (intent.action == DownloadManager.ACTION_DOWNLOAD_COMPLETE) {
            ...
            if (downloadHandler.iDownloadId == id) {
                ...
                if (!success) {
                    ...
                    downloadsIntent =
                        newuibrowser.utils.Utils.getIntentForDownloads(mActivity, userPreferences.downloadDirectory)

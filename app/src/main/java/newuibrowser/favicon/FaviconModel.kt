package newuibrowser.favicon

import newuibrowser.R
import newuibrowser.extensions.invert
import newuibrowser.extensions.pad
import newuibrowser.extensions.safeUse
import newuibrowser.utils.getFilteredColor
...
class FaviconModel @Inject constructor(
    ...
    private val faviconCache = object : LruCache<String, Bitmap>(newuibrowser.utils.FileUtils.megabytesToBytes(1).toInt()) {
    ...
    fun createDefaultBitmapForTitle(title: String?): Bitmap {
        ...
        @ColorInt val defaultFaviconColor = newuibrowser.utils.DrawableUtils.characterToColorHash(firstTitleCharacter, application)

        return newuibrowser.utils.DrawableUtils.createRoundedLetterImage(
            firstTitleCharacter,
            bookmarkIconSize,
            bookmarkIconSize,
            defaultFaviconColor

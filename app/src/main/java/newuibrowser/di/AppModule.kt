...
import newuibrowser.device.BuildInfo
import newuibrowser.device.BuildType
import newuibrowser.extensions.landscapeSharedPreferencesName
import newuibrowser.extensions.portraitSharedPreferencesName
import newuibrowser.html.ListPageReader
import newuibrowser.html.bookmark.BookmarkPageReader
import newuibrowser.html.homepage.HomePageReader
import newuibrowser.js.InvertPage
import newuibrowser.js.TextReflow
import newuibrowser.js.ThemeColor
...
import newuibrowser.html.incognito.IncognitoPageReader
...
class AppModule {
    ...
    fun providesSuggestionsHttpClient(application: Application): Single<OkHttpClient> = Single.fromCallable {
        ...
        return@fromCallable OkHttpClient.Builder()
            .cache(Cache(suggestionsCache, newuibrowser.utils.FileUtils.megabytesToBytes(1)))

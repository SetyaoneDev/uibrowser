...
object ThemeUtils {
    ...
    private fun getVectorDrawable(context: Context, drawableId: Int): Drawable {
        ...
        newuibrowser.utils.Preconditions.checkNonNull(drawable)
    ...
    fun getSearchBarColor(requestedColor: Int): Int {
        ...
        return if (luminance > 0.9) {
            ...
            newuibrowser.utils.DrawableUtils.mixColor(0.20f, requestedColor, Color.BLACK)
        } else {
            // Make search text field background lighter
            newuibrowser.utils.DrawableUtils.mixColor(0.20f, requestedColor, Color.WHITE)
        }
    }
    ...
    fun getSearchBarFocusedColor(requestedColor: Int): Int {
        ...
        return if (luminance > 0.9) {
            // Too bright, make it darker then
            newuibrowser.utils.DrawableUtils.mixColor(0.35f, requestedColor, Color.BLACK)
        } else {
            // Make search text field background lighter
            newuibrowser.utils.DrawableUtils.mixColor(0.35f, requestedColor, Color.WHITE)
        }
    }

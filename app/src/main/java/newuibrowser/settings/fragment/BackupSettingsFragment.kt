...
import newuibrowser.bookmark.LegacyBookmarkImporter
import newuibrowser.bookmark.NetscapeBookmarkFormatImporter
...
import newuibrowser.activity.SettingsActivity
...
import newuibrowser.di.AdBlockPrefs
import newuibrowser.di.DatabaseScheduler
import newuibrowser.di.DevPrefs
import newuibrowser.di.MainScheduler
import newuibrowser.di.PrefsLandscape
import newuibrowser.di.PrefsPortrait
import newuibrowser.di.UserPrefs
import newuibrowser.extensions.drawable
import newuibrowser.extensions.fileName
import newuibrowser.extensions.resizeAndShow
import newuibrowser.extensions.snackbar
import newuibrowser.extensions.toast
...
class BackupSettingsFragment : AbstractSettingsFragment() {
                                ...
                                .subscribeBy(
                                    ...
                                    onError = { throwable ->
                                        ...
                                        if (activity != null && !activity.isFinishing && isAdded) {
                                            newuibrowser.utils.Utils.createInformativeDialog(activity, R.string.title_error, R.string.bookmark_export_failure)
                                        } else {
                ...
                context?.contentResolver?.openInputStream(uri).let { inputStream ->
                    ...
                    GlobalScope.launch(Dispatchers.Main) {
                        try {
                            ...
                            newuibrowser.utils.Utils.createInformativeDialog(requireActivity(), R.string.title_error, R.string.import_bookmark_error)
                        }
                    }
                }
            }
    ...
    private fun requestSettingsExport() : Boolean {
        val intent = Intent(Intent.ACTION_CREATE_DOCUMENT).apply {
            ...
            // That is a neat feature as it guarantee no file will be overwritten.
            putExtra(Intent.EXTRA_TITLE, "UibrowserSettings$timeStamp.txt")
        }

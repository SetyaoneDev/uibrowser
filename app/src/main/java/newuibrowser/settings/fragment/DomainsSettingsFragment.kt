...
class DomainsSettingsFragment : AbstractSettingsFragment() {
    ...
    fun populateDomainList(view: View) {
        ...
        prefDefault.order = 5
        prefDefault.fragment = "newuibrowser.settings.fragment.DomainSettingsFragment"
        ...
        if (directory.exists() && directory.isDirectory) {
            ...
            list?.forEach {
                view.postDelayed({
                    ...
                    pref.fragment = "newuibrowser.settings.fragment.DomainSettingsFragment"
                    ...
                    faviconModel.faviconForUrl("http://$domain","",(activity as? ThemedActivity)?.isDarkTheme() == true)
                        ...
                        .subscribeBy(
                            onSuccess = { bitmap ->
                                pref.icon = bitmap.scale(newuibrowser.utils.Utils.dpToPx(24f), newuibrowser.utils.Utils.dpToPx(24f)).toDrawable(resources)
                            }
                        )

...
import newuibrowser.extensions.findViewByType
import newuibrowser.extensions.onceOnLayoutChange
...
import newuibrowser.utils.Utils.startActivityForFolder
...
class DebugSettingsFragment : AbstractSettingsFragment() {
    ...
    private fun openCrashLogsFolder() {
        startActivityForFolder(context, newuibrowser.utils.FileUtils.getFolderCrashLogs().absolutePath)
    }

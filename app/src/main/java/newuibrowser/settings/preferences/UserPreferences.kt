package newuibrowser.settings.preferences

import newuibrowser.AccentTheme
import newuibrowser.AppTheme
import newuibrowser.BuildConfig
import newuibrowser.R
import newuibrowser.adblock.AbpUpdateMode
import newuibrowser.constant.DEFAULT_ENCODING
import newuibrowser.constant.Uris
import newuibrowser.device.ScreenSize
...
import newuibrowser.utils.FileUtils
import newuibrowser.view.RenderingMode
import android.content.SharedPreferences
import newuibrowser.browser.SuggestionNumChoice
import newuibrowser.enums.LogLevel
import newuibrowser.enums.HeaderInfo
import newuibrowser.enums.IncomingViewAction
import newuibrowser.enums.LayerType
import newuibrowser.settings.preferences.delegates.booleanPreference
import newuibrowser.settings.preferences.delegates.enumPreference
import newuibrowser.settings.preferences.delegates.floatResPreference
import newuibrowser.settings.preferences.delegates.intPreference
import newuibrowser.settings.preferences.delegates.stringPreference

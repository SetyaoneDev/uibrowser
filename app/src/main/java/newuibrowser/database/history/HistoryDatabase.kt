 ...
 */
package newuibrowser.database.history

import newuibrowser.database.HistoryEntry
import newuibrowser.database.databaseDelegate
import newuibrowser.extensions.firstOrNullMap
import newuibrowser.extensions.useMap
...
class HistoryDatabase @Inject constructor(
    ...
    private fun HistoryEntry.toContentValues() = ContentValues().apply {
        put(newuibrowser.database.history.HistoryDatabase.KEY_URL, url)
        put(newuibrowser.database.history.HistoryDatabase.KEY_TITLE, title)
        put(newuibrowser.database.history.HistoryDatabase.KEY_TIME_VISITED, lastTimeVisited)
    }

package newuibrowser.database.adblock

import newuibrowser.adblock.UnifiedFilterResponse
import newuibrowser.database.adblock.UserRulesRepository.Companion.RESPONSE_BLOCK
import newuibrowser.database.adblock.UserRulesRepository.Companion.RESPONSE_EXCLUSION
import newuibrowser.database.adblock.UserRulesRepository.Companion.RESPONSE_NOOP
import newuibrowser.database.databaseDelegate
...
class UserRulesDatabase @Inject constructor(
    ...
    private fun UnifiedFilterResponse.toContentValues() = ContentValues(10).apply {
        put(newuibrowser.database.adblock.UserRulesDatabase.KEY_RESPONSE, response.toInt())
        put(newuibrowser.database.adblock.UserRulesDatabase.KEY_PATTERN, filter.pattern)
        put(newuibrowser.database.adblock.UserRulesDatabase.KEY_FILTER_TYPE, filter.filterType)
        put(newuibrowser.database.adblock.UserRulesDatabase.KEY_CONTENT_TYPE, filter.contentType)
        put(newuibrowser.database.adblock.UserRulesDatabase.KEY_THIRD_PARTY, filter.thirdParty)
        put(newuibrowser.database.adblock.UserRulesDatabase.KEY_DOMAIN_MAP, filter.domains?.toDBString() ?: "")
    }

...
abstract class LocaleAwareActivity :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mLastLocale = newuibrowser.locale.LocaleUtils.requestedLocale(userPreferences.locale)
        newuibrowser.locale.LocaleUtils.updateLocale(this, mLastLocale)
    ...
    override fun onConfigurationChanged(newConfig: Configuration) {
        val requestedLocale = newuibrowser.locale.LocaleUtils.requestedLocale(userPreferences.locale)

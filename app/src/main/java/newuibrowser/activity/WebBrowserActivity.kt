...
import newuibrowser.browser.*
import newuibrowser.browser.bookmarks.BookmarksDrawerView
import newuibrowser.browser.cleanup.ExitCleanup
import newuibrowser.browser.sessions.SessionsPopupWindow
import newuibrowser.browser.tabs.TabsDesktopView
import newuibrowser.browser.tabs.TabsDrawerView
import newuibrowser.database.Bookmark
import newuibrowser.database.HistoryEntry
import newuibrowser.database.SearchSuggestion
import newuibrowser.database.WebPage
import newuibrowser.database.bookmark.BookmarkRepository
import newuibrowser.database.history.HistoryRepository
import newuibrowser.databinding.ActivityMainBinding
import newuibrowser.databinding.ToolbarContentBinding
import newuibrowser.di.*
import newuibrowser.dialog.BrowserDialog
import newuibrowser.dialog.DialogItem
import newuibrowser.dialog.LightningDialogBuilder
import newuibrowser.enums.HeaderInfo
import newuibrowser.extensions.*
import newuibrowser.html.bookmark.BookmarkPageFactory
import newuibrowser.html.history.HistoryPageFactory
import newuibrowser.html.homepage.HomePageFactory
import newuibrowser.html.incognito.IncognitoPageFactory
import newuibrowser.notifications.IncognitoNotification
import newuibrowser.permissions.PermissionsManager
import newuibrowser.search.SearchEngineProvider
import newuibrowser.search.SuggestionsAdapter
import newuibrowser.settings.NewTabPosition
import newuibrowser.settings.fragment.BottomSheetDialogFragment
import newuibrowser.settings.fragment.DisplaySettingsFragment.Companion.MAX_BROWSER_TEXT_SIZE
import newuibrowser.settings.fragment.DisplaySettingsFragment.Companion.MIN_BROWSER_TEXT_SIZE
import newuibrowser.settings.fragment.SponsorshipSettingsFragment
import newuibrowser.ssl.SslState
import newuibrowser.ssl.createSslDrawableForState
import newuibrowser.ssl.showSslDialog
import newuibrowser.utils.*
import newuibrowser.view.*
import newuibrowser.view.SearchView
import io.reactivex.Completable
import io.reactivex.Scheduler
import io.reactivex.rxkotlin.subscribeBy
import junit.framework.Assert.assertNull
import newuibrowser.app
import newuibrowser.setAnalyticsCollectionEnabled
import newuibrowser.setCrashlyticsCollectionEnabled
...
//        }
    ...
    private fun createNotificationChannel() {
        ...
        CHANNEL_ID = "Ui Browser Channel ID"
    ...
    override fun executeAction(@IdRes id: Int): Boolean {
        ...
        when (id) {
            ...
            R.id.action_translate -> {
                // Get our local
                val locale = newuibrowser.locale.LocaleUtils.requestedLocale(userPreferences.locale)
...
//                }
    ...
    lateinit var iShortcuts: newuibrowser.keyboard.Shortcuts
    ...
    private fun createKeyboardShortcuts() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            iShortcuts = newuibrowser.keyboard.Shortcuts(this)
        }
    }
